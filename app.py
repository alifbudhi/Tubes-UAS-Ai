...
st.markdown(
    ...
    "AI generatif dan kebiasaan belajar. *Final Project AI & Big Data KELOMPOK 1 2026.*"
    "ALIF BUDHIHARJA SYAHPUTRA"
)
...
if st.button(" Prediksi Risiko Burnout Parah", type="primary", use_container_width=True):
    ...
    if pred == 1:
        ...
        st.success(f" **RISIKO BURNOUT RENDAH ATAU SEDANG**")
        st.markdown(
